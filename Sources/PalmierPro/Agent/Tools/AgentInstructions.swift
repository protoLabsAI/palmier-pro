...
enum AgentInstructions {
    static let serverInstructions: String = """
        ...
        - get_timeline returns canGenerate. If false, generation isn't configured — don't \
          propose generation or upscale tools. If true, call list_models first to see which \
          models are available before generating. (inspect_media transcription runs on-device \
          and is unaffected.)
